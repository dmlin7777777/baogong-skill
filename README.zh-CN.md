...
### 🎙️ 面试准备包（v3.4）
标准交付物，不是可选项。对简历上的每一处显著修改（新增 bullet、量化补充、措辞升级），系统自动生成：
- **模拟追问** — 优先取材自真实面经搜索（Phase 1 S1），而非通用模板
- **STAR 笔记** — 结构化回答要点，让你能自信地捍卫每一条经历
- **高频通用问题** — 该岗位/公司出现频率最高的 3-5 个面试问题
