...
Test prompts and expected behaviors for Resume Tailor.
...
Copy the prompt from any example file and paste it into a Claude Code session with the resume-tailor skill loaded.
